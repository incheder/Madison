...
public class MainActivity extends AppCompatActivity
    ...
    @Override
    public void onNavigationDrawerItemSelected(int position,boolean savedInstanceState) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_shopping_cart) {
            ...
            ft.replace(R.id.container, CheckoutFragment.newInstance("", ""));
   ...
   /* @Override
    ...
    private void shouldDisplayHomeUp() {
        ...
        getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_action_action_shopping_cart);
